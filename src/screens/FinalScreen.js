...
const FinalScreen = ({ route, navigation }) => {
  ...
  const finalResultTest1 = ((dexterityResult=="Healthy")&&(dexterityResult=="Healthy"))? "not suffering from upper muscle rigidity.": "suffering from upper muscle rigidity."
  const finalResultTest2 = ((dexterityResult=="Healthy")&&(dexterityResult=="Healthy"))? "not suffering from upper limb tremor.": "suffering from upper limb tremor."
  const finalResult = ((dexterityResult=="Healthy")&&(dexterityResult=="Healthy"))? "Your test results show that you are healthy.": "You are likely experiencing some Parkinson’s Disease symptoms. We advise that you pay a visit to your Primary Care Doctor."
  const colorx= finalTest ? "green":"red";
  console.log("You passed the first and second test successfully \nYour results are:\n For the Dexterity test you seem",dexterityResult,"\nFor the Tremor test you seem",tremorResult)
  return (
